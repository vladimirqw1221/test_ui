## Полный примет проекта запуска тестов с генерацией allure отчетов, непрерывной интеграции и запуска через телеграм бота в любой момент, когда требуется пройти тесты
